...
macro_rules! impl_set_handler_fn {
    ($h:ty) => {
        ...
        impl Entry<$h> {
            ...
            #[inline]
            pub fn get_handler_fn(&self) -> u32 {
                self.pointer_low as u32 | ((self.pointer_middle as u32) << 16)
            }
        }
    };
}
...
mod test {
    ...
    fn size_test() {
        use core::mem::size_of;
        assert_eq!(size_of::<Entry<HandlerFunc>>(), 8);
        assert_eq!(size_of::<InterruptDescriptorTable>(), 256 * 8);
    }
}
